...
namespace UnityVolumeRendering
{
    ...
    public class V3DRawDatasetImporter
    {
        string filePath;
        private int dimX;
        private int dimY;
        ...
        public V3DRawDatasetImporter(string filePath, int dimX, int dimY, int dimZ, DataContentFormat contentFormat, Endianness endianness, int skipBytes)
        {
